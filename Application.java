...
public class Application {
	...
	{
		final String PCAP_FILE_KEY = Application.class.getName() + ".pcapFile";
	...
	public static void readpacket(PcapHandle newHandle) throws PcapNativeException, NotOpenException, IOException
	{
		...
		for(int i = 0; i<1; i ++)
		{
			try
			{
				...
				EthernetPacket ethernet = buildEthernet((MacAddress) MacAddress.getByName(destMAC), (MacAddress) MacAddress.getByName(srcMAC),originalType, ipv4);
	...
	public static IpV4Packet.Builder buildIPv4(IpVersion version, byte ihl, IpV4Tos tos, short totalLength, short identification, short fragmentOffset, byte ttl, IpNumber protocol, short headerChecksum, Inet4Address srcIP, Inet4Address destIP, TcpPacket.Builder payload)
	{
